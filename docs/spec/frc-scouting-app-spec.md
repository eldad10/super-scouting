...
**Status:** DRAFT v0.26 — **topics 1–13, 15 and 18 CLOSED.** Every feature topic plus the system architecture and the deployment/operations model. Core forks decided (storage, versioning, offline stats, stack, access model, language, roles/auth, data-entry UX, offline-first & sync, realtime deferred → 45s refresh, dashboards & visualisation, search/ranking/browse, data quality, alliance selection, repo layout & services, environments & operations). Remaining: 14 (formal close of the deferred TBA import), 19, and the partials 16/17/20.
...
**Closed 2026-09-01:** Q18.1, Q18.3–Q18.11 → confirmed requirements or §24 (**topic 18 CLOSED**).
...
All seven top blockers are now closed, and **topics 1–13 plus 15 and 18 are fully CLOSED** — every feature topic, the system architecture and the deployment/operations model. Remaining: 14 (TBA import — already deferred to §24, still to be formally closed), 19 (delivery phases), and the partials (16/17/20). The next work is **build-shaped, not feature-shaped**: close 16/17/19, formally close 14, then write `SPEC-FINAL.md` and `IMPLEMENTATION-PLAN.md`.
