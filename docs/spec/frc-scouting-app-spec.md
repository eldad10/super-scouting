...
All seven top blockers are now closed, and **topics 1–10 and 13 are fully CLOSED**. The operational-stats meta-field catalogue and the all-dashboard value-shading rule are finalized in §10.2. Remaining open topics: 11 (search/ranking/browse), 12 (alliance selection), 14 (TBA import — deferred to §24 but still to be formally closed), 18, 19, and the partials (15/16/17/20).
